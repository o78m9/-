...
- **ISACA** — _Auditing Artificial Intelligence_ (2nd ed., 2024) — multi-framework AI audit guidance
- **ENISA** — _Multilayer Framework for Good Cybersecurity Practices for AI_ (Mar 2023) — multi-layer integration
