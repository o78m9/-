...
> _Audit:_ Queries sent: 9 (Reddit: 3, HN: 2, Web: 4). Sources received: 47. Sources cited: 12. (Training knowledge: 0 — `[Background]` lines excluded from count.)
...
- **vs cs-grill-master** (plan interrogator): different domain — pulse runs an _intake-then-search_ workflow, grill walks a decision tree.
