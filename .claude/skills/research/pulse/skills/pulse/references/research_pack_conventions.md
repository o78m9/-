...
7. **Daniel Susskind, "Show your work" — _Communications of the ACM_, 2024.** Argues for AI systems making their reasoning + sources auditable. Source for the three-count audit log pattern: instead of hiding the funnel, surface it so the user can interrogate the synthesis.
