...
>
> _Why I'm asking:_ Specificity dictates search quality. Vague topics produce vague briefings. If your topic is broad, I'd rather narrow it now than spend a search budget on noise.
...
>
> _Why I'm asking:_ The angle dictates which sources weight more (Reddit for sentiment, HN for technical critique, Web for trend coverage) and how I rank the synthesis.
...
>
> _Why I'm asking:_ 7 days catches breaking conversation; 90 days catches sustained narrative shift. Pick based on how recent the news matters.
...
>
> _Why I'm asking:_ Skipping a platform saves search budget. Reddit dominates sentiment; HN dominates technical critique; Web dominates breadth; X dominates breaking conversation. Skip what doesn't fit your angle.
...
_Generated: [DATE] | Angle: [Q2 choice]_
...
_Audit:_ Queries sent: N (Reddit: a, HN: b, Web: c, X: d|skipped).
