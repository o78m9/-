...
>
> _Why I'm asking:_ Each action takes a different path through the UI and requires different parameters. Naming the action upfront prevents wasted screenshots and lets me ask only the follow-up questions that apply.
...
> **Which notebook?** _(asked for actions 1, 2, 3 — not for "create new")_
>
> _Why I'm asking:_ If you give me a name, I'll search the homepage; if you give me a URL, I'll navigate directly. Names that are ambiguous will get a disambiguation prompt with screenshots.
...
>
> _Why I'm asking:_ Each source type goes through a different sub-flow in the Add Source dialog. Picking upfront saves a step."
...
>
> _Why I'm asking:_ The output type sets the UI button to find. The custom prompt is mandatory for quality."
...
>
> _Why I'm asking:_ This becomes the custom prompt. **Default Studio prompts produce mediocre output — specific direction produces sharp output.**
