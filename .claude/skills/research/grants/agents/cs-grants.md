...
> "Saved: <path>/grants*<topic>*<date>.docx. Plan tier: {tier}. Audit: 5 Consensus + N RePORTER + M NOSI fetches. Verdict on institute targets: <top-3>. Submission window per mechanism table embedded."
