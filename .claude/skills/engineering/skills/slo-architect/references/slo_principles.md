...
- _Google SRE Workbook_ (Beyer, Murphy, Rensin et al.) — Chapter 2 (SLO design), Chapter 5 (alerting on SLOs). Free at sre.google/workbook.
- _Implementing Service Level Objectives_ (Alex Hidalgo) — covers operationalization beyond Google's frame.
