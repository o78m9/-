...
| **Security Score** _(opt-in)_    | ≥40              | ≥50                         | ≥70                                           |
| **Hardcoded Secrets** _(opt-in)_ | None             | None                        | None                                          |
| **Input Validation** _(opt-in)_  | Basic            | Comprehensive               | Advanced with sanitization                    |
...
#### Security Requirements _(opt-in with --include-security)_
