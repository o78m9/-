...
- Imbens, G. & Rubin, D. (2015). _Causal Inference for Statistics, Social, and Biomedical Sciences_. Cambridge.
- Kohavi, R., Tang, D., & Xu, Y. (2020). _Trustworthy Online Controlled Experiments_. Cambridge.
- Cohen, J. (1988). _Statistical Power Analysis for the Behavioral Sciences_. 2nd ed.
- Wilson, E.B. (1927). "Probable Inference, the Law of Succession, and Statistical Inference." _JASA_ 22(158): 209–212.
