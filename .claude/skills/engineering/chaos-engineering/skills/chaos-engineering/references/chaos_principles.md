...
Bad: _"What happens if the database goes down?"_
Good: _"When the primary database fails over, p99 checkout latency stays below 800ms and conversion rate stays within 2% of baseline."_
...
- _Chaos Engineering_ (Casey Rosenthal, Nora Jones) — O'Reilly, 2020
- _Learning Chaos Engineering_ (Russ Miles) — O'Reilly, 2019
