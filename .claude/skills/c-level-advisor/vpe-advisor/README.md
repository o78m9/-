...
**Critical:** NOT a CTO replacement. CTO owns _what to build_ (architecture, scaling cliffs, build-vs-buy); VPE owns _how to ship it_ (delivery, hiring, team structure, production). At early stage these are often the same person; at scale they're distinct roles.
