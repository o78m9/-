...
- **vs cs-cto-advisor:** CTO owns _what to build_ (architecture, scaling cliffs, build-vs-buy); VPE owns _how to ship it_ (delivery operations, hiring execution, team structure, production discipline). Clean split.
