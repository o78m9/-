...
_Know these. Don't dismiss them. Prospects have already heard their pitch._
...
_From win/loss data only — not wishful thinking._
...
_Must be real and provable. Each needs a proof point._
...
_Ask early in discovery to establish criteria that favor you._
...
_Last 90 days only. Older than 90 days: archive._
...
_Battlecards are only useful if current. If this is >90 days old, flag to [owner] for update._
