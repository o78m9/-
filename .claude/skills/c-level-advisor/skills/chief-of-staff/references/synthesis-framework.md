...
1. Name the deadlock explicitly: _"The C-suite is genuinely split on this. Here's why."_
2. Present the two paths cleanly with consequences
3. Recommend a time-boxed experiment if possible: _"You don't have to decide between X and Y permanently. Run X for 30 days with a clear metric for success, then reassess."_
