...
- `references/spend_management_canon.md` — A.T. Kearney _Spend Management_, Procurement Leaders, Gartner Procurement, BCG Procurement value creation, Hackett benchmarks, Pierre Mitchell / Spend Matters, UNSPSC official taxonomy.
...
1. **"Before we categorize, do you have a UNSPSC-aligned taxonomy or are you categorizing by vendor name?"**
   ...
   Canon: UNSPSC official taxonomy documentation, A.T. Kearney _Spend Management_ on category architecture.
