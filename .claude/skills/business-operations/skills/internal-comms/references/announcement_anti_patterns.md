...
**Canon:** Lencioni _The Advantage_ (2012); Adam Grant on apology mechanics; classic Strunk & White discipline on active voice.
...
**Canon:** Kotter _Leading Change_ (1996); Prosci sponsor-active-and-visible research (the #1 contributor to change success in every Prosci study since 2003).
...
**Canon:** Hiatt _ADKAR_ (Reinforcement stage); Bridges _Managing Transitions_ (Beginnings phase); Prosci 5–7 touchpoint floor research.
...
**Canon:** Heath & Heath _Switch_ (Path-shaping); Edelman Trust Barometer (unanswered-question finding); HBR Adam Grant on radical candor in organizations.
...
| 3   | Lencioni _The Advantage_ (2012)      | Practitioner book       | Passive-voice flag                    |
