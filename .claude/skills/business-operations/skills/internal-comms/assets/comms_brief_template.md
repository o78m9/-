...
```json
{
  ...
  "q_and_a_seed": [
    ...
    {
      "q": "Will my reporting line change?",
      "a": "Most ICs same manager; some reassignments notified by 6/10."
    },
    { "q": "Is this a precursor to layoffs?", "a": "No." },
    {
      "q": "Why now?",
      "a": "Cycle-time data over Q1 2026 made the coordination tax quantifiable."
    },
    {
      "q": "What about on-call?",
      "a": "Rotations merge 6/15; no engineer more days per month than today."
    }
  ],
  "change_event": {
