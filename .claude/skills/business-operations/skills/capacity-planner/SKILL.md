...
license: MIT
tags:
  [bizops, capacity, headcount, utilization, queueing-theory, ops-planning, little-law, workforce]
...
- **`c-level-advisor/vpe-advisor`** measures _engineering_ throughput
...
- **`c-level-advisor/chro-advisor`** does _strategic_ workforce
  planning (1-5 year capability portfolios, talent supply, leadership
  succession). This skill does _operational_ 0-12 month capacity
...
- **`project-management/*`** tracks delivery throughput on projects
  ...
  state queued work.
- **Sibling `process-mapper`** _finds_ the bottleneck. This skill
  _sizes the team around_ a known bottleneck. Order of operations:
...
**Why it's the first question**: Goldratt (_The Goal_, 1984) — every
...
**Canon**: Eli Goldratt, _The Goal_ (1984); Reinertsen, _Principles of
Product Development Flow_ (2009).
...
**Canon**: Frances Frei & Anne Morriss, _Uncommon Service_ (HBR Press,
2012).
...
**Canon**: Brad Cleveland, _Call Center Management on Fast Forward_ (4th
ed., 2019); A.K. Erlang, _The Theory of Probabilities and Telephone
Conversations_ (1909).
...
**Canon**: Erlang (1909); Hopp & Spearman, _Factory Physics_ (3rd ed.,
2008), VUT equation.
...
_Strategic Workforce Planning_ (USC CEO, 2008).
...
**Canon**: Camille Fournier, _The Manager's Path_ (O'Reilly, 2017),
ch. 5; Andy Grove, _High Output Management_ (1983).
...
**Canon**: Hopp & Spearman, _Factory Physics_ (2008); Reinertsen (2009)
