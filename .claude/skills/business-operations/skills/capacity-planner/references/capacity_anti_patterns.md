...
**Source:** Donald Reinertsen, _Principles of Product Development
Flow_ (2009), Principle 12: "We need to operate at lower levels of
utilization."
...
**Source:** Will Larson, _Staff Engineer_ (Stripe Press, 2021); Camille
Fournier, _The Manager's Path_ (O'Reilly, 2017).
...
Lawler, _Strategic Workforce Planning_ (USC CEO, 2008).
...
**Why it fails:** Fournier's research (and Andy Grove's _High Output
Management_ before her) is unambiguous: at 8-10+ direct reports, 1:1s
...
**Source:** Camille Fournier, _The Manager's Path_, ch. 5; Andy
Grove, _High Output Management_ (1983), ch. on managerial output.
...
**Source:** Brad Cleveland, _Call Center Management on Fast Forward_
...
**Source:** Cleveland, _Call Center Management on Fast Forward_;
...
**Source:** Hopp & Spearman, _Factory Physics_ (3rd ed., 2008) on
peak-demand staffing; Reinertsen, _Principles of Product Development
Flow_ on capacity-margin discipline.
...
This skill is for the _next 12 months_. If you are planning for a 3-year
...
Clayton Christensen and Michael Raynor's _The Innovator's Solution_
...
Pat Lencioni's _The Five Dysfunctions of a Team_ (2002) and Eli
Goldratt's _The Goal_ (1984) bookend the operational reality:
...
These appear in the _Forcing-question library_ of SKILL.md.
