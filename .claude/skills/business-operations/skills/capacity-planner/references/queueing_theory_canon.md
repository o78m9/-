...
### 1. A.K. Erlang (1909) — _The Theory of Probabilities and Telephone Conversations_
...
### 2. J.D.C. Little (1961) — _A Proof for the Queuing Formula L = λW_
...
### 3. Hopp & Spearman — _Factory Physics_ (3rd ed., 2008)
...
### 4. Donald Reinertsen — _The Principles of Product Development Flow_ (2009)
...
### 5. Sir J.F.C. Kingman — _On Queues in Heavy Traffic_ (1961)
...
### 6. Brad Cleveland — _Call Center Management on Fast Forward_ (4th ed., 2019)
...
ITIL's _Service Operation_ practice guidance codifies the canonical
...
### 8. M. Armony, S. Israelit, A. Mandelbaum, et al. — _On Patient Flow in Hospitals_ (Stochastic Systems, 2015)
