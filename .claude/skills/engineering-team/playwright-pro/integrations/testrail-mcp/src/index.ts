...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    },
    {
      ...
      description:
        'Get test cases from a project. Supports filtering by suite, section, and search text.',
      inputSchema: {
        type: 'object',
        properties: {
          project_id: { type: 'number', description: 'Project ID' },
    ...
    switch (name) {
      ...
      case 'testrail_add_case': {
        const payload: TestRailCasePayload = {
          ...
          custom_steps_separated:
            args?.custom_steps_separated as TestRailCasePayload['custom_steps_separated'],
        }
      ...
      case 'testrail_update_case': {
        ...
        if (args?.custom_steps_separated) {
          updatePayload.custom_steps_separated =
            args.custom_steps_separated as TestRailCasePayload['custom_steps_separated']
        }
