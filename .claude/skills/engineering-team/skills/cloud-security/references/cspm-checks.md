...
| NSG rule allows any-to-any              | Azure NSG       | Inbound rule with SourceAddressPrefix = _ and DestinationPortRange = _      | Critical | Replace with specific port and source ranges                            |
