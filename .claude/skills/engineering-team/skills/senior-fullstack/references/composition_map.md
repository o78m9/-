...
**Principle (Karpathy #2, Simplicity First):** do not reimplement scope that the POWERFUL-tier engineering specialists already own. This skill is the _fullstack orchestrator_; the specialists are the _implementers_. Fork into them — do not duplicate them.
