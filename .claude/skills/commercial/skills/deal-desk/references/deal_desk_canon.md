...
1. **Never auto-approve.** Even green deals get a named approver. The skill outputs _who must sign_, not _the deal is fine_.
2. **Margin, not discount.** A 30% discount on an 80%-gross-margin product reduces _margin_ by 24 points (to 56%) — not 30%. See `discount_economics.md` for the math.
...
1. **SaaStr** — Jason Lemkin's deal-desk playbooks emphasize that the deal desk's primary job is _defending gross margin and pricing integrity_, not just routing discounts. https://www.saastr.com/
2. **Winning by Design** — Jacco van der Kooij + Jason Reichl, _Bowtie Funnel_ and _Revenue Architecture_. Establishes that the deal desk owns the gate between Acquisition (sales) and Retention (CS) — bad-term deals cost more in churn than they earn in ARR. https://winningbydesign.com/
...
5. **OpenView Venture Partners** — _State of the SaaS Sales Org_ annual benchmarks. Documents discount-band conventions across stage (seed → growth → late-stage) and shows that median discount creeps up year-over-year unless deal-desk discipline is enforced. https://openviewpartners.com/
