...
license: MIT
tags:
  [commercial, rfp, rfi, rfq, shipley, win-theme, proof-points, structured-response, bid-management]
...
1. **"What's your STRONG / PARTIAL / GAP split on the MANDATORY requirements?"**
   ...
   Canon: Shipley _Proposal Guide v6_ — capture-management discipline, "Pgw (probability of win) is bounded by your weakest MANDATORY."
...
3. **"Did you enter the conversation before or after the RFP issued?"**
   ...
   Canon: Tom Searcy + Henry DeVries _How to Win Big Business_ — "If you didn't help write the RFP, you're column fodder."
...
4. **"What are your 3-5 win-themes, and does each thread through ≥2 requirements?"**
   ...
   Canon: Shipley _Capture Guide_ — win-themes are the buyer-side answer to "why us" across the evaluation criteria, not seller-side feature lists.
