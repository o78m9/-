...
1. **Shipley Associates failure-mode analyses** — internal post-loss reviews published in _Proposal Guide v6_ appendix and in _Capture Guide_ case studies. Source for anti-patterns 1, 4, 5.
...
8. **Patrick Lencioni, _Getting Naked_ (Jossey-Bass, 2010)**. Source for the "tell the kind truth" principle that operationalizes the skill's GAP-honesty hard rule (anti-pattern 1).
