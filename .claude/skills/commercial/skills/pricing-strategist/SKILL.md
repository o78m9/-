...
1. **"Is your customer paying for outcomes, seats, or usage?"**
   ...
   Canon: Ramanujam 2016 (_Monetizing Innovation_) — Mistake #1 of 9: seat-based pricing on a usage-variable product caps TAM at ~20% of WTP.
...
3. **"What's the variance in customer usage across your top decile vs. median?"**
   ...
   Canon: Kyle Poyar (_Growth Unhinged_) — high-variance products lose 60%+ of revenue on flat-rate plans.
...
4. **"What's your competitor's pricing model, and why are you choosing the same or different?"**
   ...
   Canon: David Skok (_For Entrepreneurs_) — pricing is a positioning signal.
...
6. **"What's the ONE feature that forces a tier upgrade?"**
   ...
   Canon: Ramanujam (_Monetizing Innovation_) — Mistake #4: tiers with no clear differentiator make 70% of customers pick the cheapest.
