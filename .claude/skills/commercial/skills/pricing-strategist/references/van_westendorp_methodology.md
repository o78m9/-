...
2. **"OPP is the optimal price."** — OPP is named misleadingly. It's the point of _equal
   resistance from both sides_, not a profit-maximizing price. The optimal price often sits
   between OPP and PME if the market tolerates upside.

3. **"PSM works on non-customers."** — PSM measures _perceived_ price thresholds. Run it on
