...
flags below. This document is the source-of-truth for _why_ each pattern is harmful.
...
with "more advanced features" copy — but if you can't name the _single event_ that triggers
