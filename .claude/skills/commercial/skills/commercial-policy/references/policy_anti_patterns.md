...
**Evidence.** Bain's _Pricing Power_ research identifies this as the single most common policy defect in mid-market SaaS. The fix is structural: the CFO must own the margin floor; that floor must show up as a per-cell field in the matrix.
...
5. Winning by Design (Jacco van der Kooij) — _Revenue Architecture_: https://winningbydesign.com/
...
8. Bain — _Pricing Power_ + Discount Discipline Studies: https://www.bain.com/insights/topics/pricing/
