...
**Prospective partner name:** ******\_\_\_******
...
- **Partner legal name:** ******\_\_\_******
- **Partner_type** (pick one): [ ] referral [ ] reseller [ ] oem [ ] si_consultant
  [ ] technology [ ] strategic_alliance
- **Who introduced them?** ******\_\_\_******
- **Why are they approaching us NOW?** ******\_\_\_******
...
- **Of their total customer base, what % are end customers (companies they sold
  ...
  `end_customer_relationships_pct` (0-100): ******\_\_\_******

- **Sales team size — how many people on their team actively sell?**

  `sales_team_size`: ******\_\_\_******
...
- **`joint_marketing_spend`** (USD per year): ******\_\_\_******
...
- **Revshare ask:** ******\_\_\_******
- **Exclusivity ask:** ******\_\_\_****** (territory / segment / vertical / none)
- **MDF ask:** ******\_\_\_******
- **Engineering integration ask:** ******\_\_\_******
- **Anything unusual:** ******\_\_\_******
