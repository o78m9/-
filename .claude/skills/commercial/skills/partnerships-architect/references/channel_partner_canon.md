...
1. **Robert Caro** — _The Years of Lyndon Johnson_ (especially the chapters on the LBJ
...
4. **Forrester Research** — _Channel Software Tech Stack_ (annual report) and
...
5. **IDC** — _Worldwide Channel Software Tracker_ and IDC partner research. Cost-to-serve
...
6. **Tien Tzuo** — _Subscribed_ (Portfolio, 2018), founder of Zuora. Channel chapter
...
7. **Geoffrey Moore** — _Crossing the Chasm_ (HarperBusiness, 1991/2014 revised) and
   _Inside the Tornado_ (HarperBusiness, 1995). Introduces the "whole product"
