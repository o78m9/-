...
1. **Forrester Research** — _Channel Software Tech Stack_ and partner-led research
...
7. **Salesforce AppExchange research** — public AppExchange ISV partner research, 2015- 2024. Source for partnership-ending anti-patterns and the data on ISV partner
   churn correlated with absent offboarding clauses.
8. **Pradeep Chintagunta** (Chicago Booth) — _Channel power, channel investment, and
   partner economics_ academic literature. Source for the principle that channel
