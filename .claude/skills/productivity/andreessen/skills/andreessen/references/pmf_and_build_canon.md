...
Sean Ellis (2009, while at Dropbox/LogMeIn lineage) proposed surveying users: _"How would you feel
if you could no longer use this product?"_ If **≥ 40%** answer "very disappointed," that is a strong
...
institutions is an inability to _build_ — and that the corrective is a cultural bias toward making
things rather than deliberating about them.

> "The problem is desire. We need to _want_ these things. … The problem is inertia. We need to want
...
7. Eric Ries, _The Lean Startup_ (2011) — the build-measure-learn loop that complements the
