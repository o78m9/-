...
was later collected in _The Pmarca Blog Archives_ PDF, a16z).

## Why market dominates (the mechanism)

Andreessen's argument is not sentiment — it is about where the _pull_ comes from:
...
- **Timing is doing a lot of work** inside "market." A market that does not exist _yet_ but will
...
2. _The Pmarca Blog Archives_ (collected essays, a16z PDF). Confidence: high.
