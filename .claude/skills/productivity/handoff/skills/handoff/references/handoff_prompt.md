...
- Hard cap at 5.
- Each entry: skill name + one-line _why this session needs it_.
...
Test the last item by asking yourself: _if I close the conversation right now and a stranger opens this doc, do they know the next 30 minutes of work?_ If no, go back to Step 1.
