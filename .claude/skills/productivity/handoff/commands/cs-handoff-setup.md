...
1. **Save location** — OS temp / home folder / hidden home folder / per-project / custom. _No pre-selected default — explicit choice required on first run._
...
6. **Filename style** _(only if save location ≠ temp)_ — date_slug / timestamp / mktemp.
