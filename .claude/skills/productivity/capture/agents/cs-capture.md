...
**Opening:** _(silent — capture is fast-to-action; no preamble. Goes straight to organizing the dump.)_
...
>
> _Why I'm asking:_ If I guess wrong I either bury a project as a task or inflate a task into a project that doesn't need the structure.
