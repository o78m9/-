...
const FAQS = [
  ...
  {
    q: 'ماذا يحدث ببيانات مرضاي عند إلغاء الاشتراك؟',
    a: 'بيانات مرضاك ملكك بالكامل. عند إلغاء الاشتراك تُحذف جميع البيانات من خوادمنا خلال أسبوع، وتستلم نسخة كاملة منها قبل الحذف. لا نحتفظ بأي معلومات بعد إلغاء الاشتراك.',
  },
  {
    q: 'من أي رقم ترسل الرسائل على مرضاي؟',
    a: 'الرسائل ترسل من رقم WhatsApp Business مرتبط باسم عيادتك أنت — ليس من رقم مجهول. المريض يرى اسم عيادتك وشعارها مباشرةً. نساعدك على ربط رقمك خلال الإعداد الأول.',
  },
  {
    q: 'هل أقدر أوقف الرسائل عن مريض بعينه؟',
    a: 'نعم، بضغطة واحدة مع تسجيل السبب (ظرف شخصي، خلاف، طلب عدم التواصل...). الإيقاف مؤقت دائماً — النظام يستأنف التواصل تلقائياً بمجرد أن يحجز المريض موعداً جديداً، دون أي جهد منك.',
  },
] as const
